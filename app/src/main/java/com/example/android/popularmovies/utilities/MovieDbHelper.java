                 ...
                 */
                  MovieContract.MovieEntry._ID               + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                   ...
                   MovieContract.MovieEntry.COLUMN_TITLE       + " TEXT NOT NULL, "                 +
                        MovieContract.MovieEntry.COLUMN_IMAGEID + " TEXT NOT NULL,"                +
                  MovieContract.MovieEntry.COLUMN_PLOT +" TEXT NOT NULL,"         +
                  MovieContract.MovieEntry.COLUMN_VOTING+" TEXT NOT NULL,"        +
                  MovieContract.MovieEntry.COLUMN_DATE+" TEXT NOT NULL,"        +
                  MovieContract.MovieEntry.COLUMN_TRAILER+" TEXT NOT NULL,"      +
                  MovieContract.MovieEntry.COLUMN_REVIEW + " TEXT NOT NULL," +
